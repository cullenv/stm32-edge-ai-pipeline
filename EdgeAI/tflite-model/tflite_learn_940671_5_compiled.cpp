 ...
 */
// Generated on: 26.03.2026 20:22:14
...
const TfArray<1, float> quant0_scale = { 1, { 0.0042839213274419308, } };
const TfArray<1, int> quant0_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(8) int32_t tensor_data1[2] = { -1476, 1476, };
const TfArray<1, int> tensor_dimension1 = { 1, { 2 } };
const TfArray<1, float> quant1_scale = { 1, { 5.4004656703909859e-05, } };
const TfArray<1, int> quant1_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data2[2*10] = { 
  38, -52, 37, 122, 92, -118, 44, -61, 50, 100, 
  36, 7, -12, -79, -78, 77, -127, 35, -93, -36, 
};
const TfArray<2, int> tensor_dimension2 = { 2, { 2,10 } };
const TfArray<1, float> quant2_scale = { 1, { 0.010875191539525986, } };
const TfLiteAffineQuantization quant2 = { (TfLiteFloatArray*)&quant2_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data3[10] = { 0, 0, 0, -568, -3018, 4600, -1275, 2681, -2006, -1290, };
const TfArray<1, int> tensor_dimension3 = { 1, { 10 } };
const TfArray<1, float> quant3_scale = { 1, { 3.051592648262158e-05, } };
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data4[10*20] = { 
  13, -26, -22, 4, 33, 5, 38, -35, -2, -17, 8, 6, 21, 38, 18, -27, 0, -9, -23, 8, 
  -19, -38, 23, 22, 18, -14, -17, -32, -31, 6, -17, -18, 21, 7, 23, 30, -17, 11, -15, -10, 
  -8, -32, -1, 35, -16, -20, -12, 7, -14, -4, 11, 17, -7, -29, -4, -23, 28, -32, -33, -27, 
  20, -3, 31, 1, 46, 99, -19, -50, -5, 24, 48, 30, -24, -31, -1, -15, -9, -5, 49, 121, 
  -15, 4, -32, -14, 25, 84, -12, -29, -34, 20, 36, 24, -7, 16, 8, -32, -16, 39, 30, 98, 
  -29, 45, -23, 17, -87, -122, -2, 76, -32, -16, 18, 14, -17, 21, -8, -22, -12, 14, -32, -101, 
  31, 5, -20, -26, 103, 108, 4, -51, -6, 1, 36, 27, -24, -14, 3, -6, 20, 7, 10, 89, 
  -5, 44, 15, 20, -51, -26, 29, -1, 40, -10, -25, 33, 22, -9, -33, 17, 29, -3, -1, -45, 
  21, 2, 18, 14, 93, 82, -36, -47, -10, 4, 42, 17, -2, -35, -11, 32, -29, 33, -5, 79, 
  15, -34, -5, -1, 103, 116, -7, -36, 28, -31, -5, 30, -25, -18, 19, -6, -6, 43, 16, 127, 
};
const TfArray<2, int> tensor_dimension4 = { 2, { 10,20 } };
const TfArray<1, float> quant4_scale = { 1, { 0.011519026011228561, } };
const TfLiteAffineQuantization quant4 = { (TfLiteFloatArray*)&quant4_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data5[20] = { 0, 2828, 0, 0, -1847, -1033, 0, 2328, 787, 0, -910, -474, 0, 0, 0, 0, 0, -1401, -1389, -785, };
const TfArray<1, int> tensor_dimension5 = { 1, { 20 } };
const TfArray<1, float> quant5_scale = { 1, { 5.8009303756989539e-05, } };
...
const TfArray<1, float> quant9_scale = { 1, { 0.034905429929494858, } };
...
TfLiteStatus tflite_learn_940671_5_init( void*(*alloc_fnc)(size_t,size_t) ) {
...
TfLiteStatus tflite_learn_940671_5_input(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(in_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_940671_5_output(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(out_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_940671_5_invoke() {
...
TfLiteStatus tflite_learn_940671_5_reset( void (*free_fnc)(void* ptr) ) {
#ifdef EI_CLASSIFIER_ALLOCATION_HEAP
